  ...
  return (
    <SettingsLayout>
      ...
      <Card className="bg-zinc-900 mb-6">
        <CardHeader className="text-lg font-semibold text-white">How it works</CardHeader>
      ...
      <Card className="bg-zinc-900 mb-6">
        <CardHeader className="text-lg font-semibold text-white">Share your referral link</CardHeader>
        <CardContent className='text-white'>
          ...
          <div className="flex space-x-2 mb-4">
            ...
            <Button variant="secondary" size="sm">in</Button>
            <Button variant="secondary" size="sm">TG</Button>
          </div>
          <div className="flex space-x-2">
            <Input value="https://drpc.org/ref=8ddbf4" readOnly className="bg-zinc-800" />
            <Button variant='secondary' className="bg-green-500 text-white text-sm hover:bg-green-600">Copy</Button>
          </div>
        </CardContent>
      </Card>

      <Card className="bg-zinc-900 mb-6">
        <CardHeader className="text-lg font-semibold text-white">Invite via email</CardHeader>
        <CardContent className='text-white'>
      ...
      <Card className="bg-zinc-900">
        <CardHeader className="text-lg font-semibold text-white">Add dRPC badge to your website</CardHeader>
        <CardContent>
          ...
          <Button variant="secondary" className="w-full">Copy code</Button>
        </CardContent>
      </Card>
    </SettingsLayout>
  );
